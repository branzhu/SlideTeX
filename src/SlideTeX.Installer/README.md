...
- `tests/Test-MsiLifecycle.ps1`: 安装/升级/卸载链路验证脚本
...
# 验证旧版->新版升级，再卸载
pwsh ./tests/Test-MsiLifecycle.ps1 -OldMsi .\artifacts\installer\SlideTeX-1.0.0-Release-x64.msi -NewMsi .\artifacts\installer\SlideTeX-1.0.1-Release-x64.msi
